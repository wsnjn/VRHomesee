/**
 * 项目名称：融合大模型交互与3D全景预览的智能选房平台设计 with implemented Intelligent Housing Selection Platform
 * 文件名称：LandlordHouseController.java
 * 开发者：牛迦楠
 * 专业：软件工程（中外合作办学）
 * 学校：东华理工大学
 * 功能描述：房东房屋管理控制器，提供属于房东名下的房源查询、状态批量控制、信息编辑及租约到期提醒等功能
 * 创建日期：2026-01-06
 */
...
public class LandlordHouseController {
    ...
    public Map<String, Object> getLandlordHousesByStatus(
        ...
        try {
            List<RoomInfo> houses = roomInfoRepository.findByLandlordPhoneAndStatusOrderByCreatedTimeDesc(landlordPhone,
                    status);
    ...
    public Map<String, Object> updateHouseStatus(@PathVariable Long houseId,
